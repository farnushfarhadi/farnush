...
public class ST extends JFrame implements ActionListener
{
    ...
    */
        ...
        else if (esource == clusterAButton)
	{
       ...
       {
           String szMessage = "This is version 1.3.8 of the Short Time-series Expression Miner (STEM).\n\n"+
	  ...
	  this.szfile = szfile;
       ...
       public void run()
       {
             ...
             else if (szfile.equals(GoAnnotations.SZGP+"goa_chicken.gz"))
	     {
             ...
             else if (szfile.equals(GoAnnotations.SZGP+"goa_cow.gz"))
	     {
             ...
             else if (szfile.equals(GoAnnotations.SZGP+"goa_rat.gz"))
	     {
             ...
             else if (szfile.equals(GoAnnotations.SZGP+"goa_zebrafish.gz"))
	     {
