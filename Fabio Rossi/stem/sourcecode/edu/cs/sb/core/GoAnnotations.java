...
public class GoAnnotations {
	...
	public static String[] organisms = {
			...
			"Escherichia coli (EcoCyc & EcoliHub)",// new ecocyc.gz
			...
			"Pseudomonas syringae pv. phaseolicola 1448A (JCVI)",// new
																	// phaseolicola
			"Rat (EBI)",
			...
			"Silicibacter pomeroyi DSS-3 (JCVI)", "Solanaceae (SGN)", // new
																		// sgn.gz
			...
			"Vibrio cholera (JCVI)", "Zebrafish (EBI)" };
	...
	public static String[] gannfile = {
			...
			SZGP + "sgd.gz", SZGP + "GeneDB_Spombe.gz",
			...
			SZGP + "jcvi_Vcholerae.gz", SZGP + "goa_zebrafish.gz" };
